...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="themes/<?php echo getSiteinfo('site_theme') ?>/master.css"/>
...
<body>
    <div id="mother">
        ...
        <div id="footer">Powered by <a href="http://niko-h.github.com/wurzelstrang" target="_blank">Wurzelstrang</a></div>
    </div>
    ...
    <script type="text/javascript" src="themes/<?php echo getSiteinfo('site_theme') ?>/master.js"></script>
